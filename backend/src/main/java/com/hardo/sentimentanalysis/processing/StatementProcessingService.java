...
public class StatementProcessingService {
    ...
    public void processPdf(String pdfName) throws IOException {
        ...
        var systemMessage = new SystemMessage( """
                You are an assistant that will have as input and annual financial report of OMX Nasdaq Stockholm company in text format and you have the following 7 tasks:
